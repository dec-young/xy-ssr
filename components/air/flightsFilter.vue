  ...
  methods: {
    ...
    handleFlightTimes(value) {
      ...
      const arr = this.data.flights.filter(v => {
        ...
        // arr数组是满足这个value值(例如6,12)时间段的数据
        const start = v.dep_time.split(":")[0] * 1;
    ...
    handleFiltersCancel() {
      ...
      this.$emit("reSetData", this.data.flights);
    }
  }
};
</script>
